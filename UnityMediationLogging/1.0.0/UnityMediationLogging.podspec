Pod::Spec.new do |spec|  
    spec.name         = 'UnityMediationLogging'
    spec.version      = '1.0.0'
    spec.summary      = 'UnityMediationLogging for UnityMediationSdk'
    spec.description  = 'UnityMediationLogging Framework for loading and showing ads in the UnityMediationSdk.'
...
Your use of Unity Monetization constitutes your acceptance of such terms. Unless expressly provided otherwise, the software under this license is made available strictly on an \"AS IS\" BASIS WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED. Please review the license for details on these and other terms and conditions.
    ...
    spec.source               = { :http => 'https://unity3ddist.jfrog.io/artifactory/unity-mediation-generic-prod-local/UnityMediationLogging/1.0.0/UnityMediationLogging.xcframework.zip' }
    spec.vendored_frameworks  = 'UnityMediationLogging.xcframework'
  end
